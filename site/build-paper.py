...
{body}
  ...
  <div class="paper-doc" style="margin-top:3rem;">
    <hr>
    <p class="fineprint">Live exhibit: <a class="livechip" href="{portal}" target="_blank" rel="noopener">app.34.220.64.149.sslip.io</a> &nbsp;·&nbsp; read-only demo login <code>demo@muster.dev</code> / <code>muster-demo</code></p>
